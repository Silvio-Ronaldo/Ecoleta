...
const Detail = () => {
    ...
    function handleComposeMail() {
        MailComposer.composeAsync({
            ...
            recipients: ['mercadinho123@gmail.com'],
        });
    }

    function handleWhatsapp() {
        Linking.openURL(`whatsapp://send?phone=${303030303030}&text=Tenho interesse na coleta de resíduos`); 
    }
        ...
        <SafeAreaView style={{ flex: 1 }}>
            <View style={styles.container}>
                <TouchableOpacity onPress={handleNavigateBack}>
                    <Icon name="arrow-left" size={20} color="#22FF22" />
                </TouchableOpacity>
                ...
                <Text style={styles.pointItems}>Óleo de cozinha, Material Orgânico</Text>

                <View style={styles.address}>
                    <Text style={styles.addressTitle}>Endereço</Text>
                    <Text style={styles.addressContent}>Valinhos, SP</Text>
                </View>
            </View>
